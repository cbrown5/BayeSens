...
Shrink values can occaisionally be >1. Values >1 occur when the posterior parameter estimate has moved in the opposite direction from the prior than the MLE. Values >1 can occur if 
